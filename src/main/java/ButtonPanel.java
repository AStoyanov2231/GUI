...
public class ButtonPanel extends JPanel {
    ...
    public ButtonPanel() {
        ...
        // Add vertical strut at the top to create space
        add(Box.createVerticalStrut(230)); // Adjust the height as needed
        ...
        // Add vertical strut at the bottom to create space
        add(Box.createVerticalStrut(100)); // Adjust the height as needed
    }
